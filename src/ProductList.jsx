...
function ProductList() {
    ...
    const cart = useSelector(state => state.cart.items); // Access cart state from Redux
   ...
   const handleAddToCart = (product) => {
    ...
    updateTotalQuantity(); // Update quantity when a product is added
  };
        ...
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    ...
                    {totalQuantity > 0 && (
                        <text x="50%" y="50%" textAnchor="middle" fill="white" fontSize="100px" fontWeight="bold" dy=".3em">
                            {totalQuantity}
                        </text>
                    )}
                    </svg>
